    ...
    <div className="container-body">
      ...
      <div className="container-text-competition">
        <p>
          ...
          to innovate and solve real industrial problems that really exist
          from our Company Case Contributor and innovate an advancement that
          improves the key sectors of companies which are marketing,
          operation, and EHS (Environment, Health, and Safety).
        </p>
        <p>
          Ganesha Integration Case Competition 2022 is a simulation for
          undergraduate students about the real “how working in Industry” that
